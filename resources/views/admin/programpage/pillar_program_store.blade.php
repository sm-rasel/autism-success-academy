                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <form class="custom-validation" action="{{route('admin.pillar_program_section_store')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label>Pillar Name
                                                <span class="text-danger ml-1">*</span>
                                            </label>
                                            <input type="text" required class="form-control" name="title" placeholder="Type Pillar Title here"/>
                                            @if($errors->has('title'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control" name="value_p" placeholder="Type Value here"/>
                                        ...
                                        <div class="form-group mb-0">
                                            <div>
                                                <button type="submit" class="btn btn-outline-success w-md waves-effect waves-light mr-1">Create New Pillar Section</button>
