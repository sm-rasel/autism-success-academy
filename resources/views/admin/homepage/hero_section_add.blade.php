                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <form class="custom-validation" action="{{ route('admin.hero_store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label>Header One
                                                <span class="text-danger ml-1">*</span>
                                            </label>
                                            <input type="text" name="heading_one" class="form-control" required placeholder="Type Hero Header One"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="heading_two" class="form-control" required placeholder="Type Hero Header Two"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="heading_three" class="form-control" required placeholder="Type Hero Header Three"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tag_line" class="form-control" required placeholder="Type Tag Line"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="question_text" class="form-control" required placeholder="Question Text"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="roll_out" class="form-control" required placeholder="Roll Out Text"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="button_text" class="form-control" required placeholder="Type Button Text"/>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div>
                                                <input type="file" name="logo_image" required class="form-control-file">
                                            </div>
                                        ...
                                        <div class="form-group mb-0 justify-content-end">
                                            <div>
                                                <button type="submit" class="btn btn-outline-success waves-effect w-md px-5 mr-1">Create New Hero</button>
