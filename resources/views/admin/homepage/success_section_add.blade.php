                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <form class="custom-validation" action="{{ route('admin.success_store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="checkbox" name="program_upper"/>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label>Show Program Page Second
                                                <span class="text-danger ml-1">*</span>
                                            </label>
                                            <input type="checkbox" name="program_second"/>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label>Show Program Page Third
                                                <span class="text-danger ml-1">*</span>
                                            </label>
                                            <input type="checkbox" name="program_third"/>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label>Show Program Page Bottom Section
                                                <span class="text-danger ml-1">*</span>
                                            </label>
                                            <input type="checkbox" name="program_bottom"/>
                                        </div>
                                        
                                        <div class="form-group mb-0 justify-content-end">
                                            <div>
                                                <button type="submit" class="btn btn-outline-success waves-effect w-md px-5 mr-1">Create New Success</button>
