                ...
                <div class="bg-soft-primary">
                    <div class="row">
                        ...
                        <div class="col-5 align-self-end">
                            <img src="{{asset('images/admin/images/profile-img.png')}}" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="{{asset('images/admin/images/users/avatar-1.png')}}" alt="" class="img-thumbnail rounded-circle">
                            </div>
                            <h5 class="font-size-15 text-truncate">Yeasir Zahir</h5>
                            <p class="text-muted mb-0 text-truncate">COO of ASA</p>
                        </div>
